...
export default {
  ...
  methods: {
    fnsubmit(e) {
      ...
      var paraName = getParameterByName('type');
      var callfn = "";

      if(paraName=="SilderBaner"){
        callfn = "UpdateBNByID"
      }
      else if(paraName=="BlogBanner"){
        callfn = "UpdateBNBlogByID"
      }
      else{
...
//UpdateBNByID
      ...
      this.$store.dispatch(callfn, this.DataBannerByID).then(() => {
